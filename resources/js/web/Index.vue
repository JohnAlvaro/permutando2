                    ...
                    <div class="box">
                        <div class="search-menu">
                            <div class="title">
                                ...
                                <h2>Busco</h2>
                                <div class="check-group showto">
                                    <input type="checkbox" id="busco-1" name="inmueble" class="unique" show="busco"><label for="busco-1" class="radio-btn">Casa</label>
                                    <input type="checkbox" id="busco-2" name="inmueble" class="unique" show="busco"><label for="busco-2" class="radio-btn">Apto</label>
                                    <input type="checkbox" id="busco-3" name="inmueble" class="unique" show="busco"><label for="busco-3" class="radio-btn">Oficina</label>
                                    <input type="checkbox" id="busco-4" name="inmueble" class="unique" show="busco"><label for="busco-4" class="radio-btn">Bodega</label>
                                </div>
                            </div>
                            <div class="fields">
                         ...
                         <div class="sell-menu">
                            <div class="title">
                                ...
                                <h2>Tengo</h2>
                                <div class="check-group showto">
                                    <input type="checkbox" id="vendo-1" name="inmueble" show="vendo" @click="tengo('Casa')"  class="unique"><label for="vendo-1" class="radio-btn">Casa</label>
                                    <input type="checkbox" id="vendo-2" name="inmueble" show="vendo" @click="tengo('Apto')" class="unique"><label for="vendo-2" class="radio-btn">Apto</label>
                                    <input type="checkbox" id="vendo-3" name="inmueble" show="vendo" @click="tengo('Oficina')" class="unique"><label for="vendo-3" class="radio-btn">Oficina</label>
                                    <input type="checkbox" id="vendo-4" name="inmueble" show="vendo" @click="tengo('Bodega')" class="unique"><label for="vendo-4" class="radio-btn">Bodega</label>
                                </div>
                            </div>
                            <div class="fields">
                                <div class="check-group estado showto">
    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="form-field">
                <div class="my-radio">
                    <span>Balcón</span>
                    <input type="radio" v-model="form.balcon" value="true" id="balcon_1"><label for="balcon_1">Si</label>
                    <input type="radio" v-model="form.balcon" value="false" id="balcon_0" checked><label for="balcon_0" class="no">No</label>
                </div>
            </div>
            <div class="form-field">
                <div class="my-radio">
                    <span>Terraza</span>
                    <input type="radio" v-model="form.terraza" value="true" id="terraza_1"><label for="terraza_1">Si</label>
                    <input type="radio" v-model="form.terraza" value="false" id="terraza_0" checked><label for="terraza_0" class="no">No</label>
                </div>
            </div>
            <div class="form-field">
                <div class="my-radio">
            ...
            <div class="form-field">
                <div class="my-radio">
                    ...
                    <input type="radio" v-model="form.parqueadero" value="true" id="parqueadero_1"><label for="parqueadero_1">Si</label>
                    <input type="radio" v-model="form.parqueadero" value="false" id="parqueadero_0" checked><label for="parqueadero_0" class="no">No</label>
                </div>
            </div>
